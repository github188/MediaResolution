// MarkupSTL.cpp: implementation of the CMarkup class.
//
// Markup Release 8.2
...
bool CMarkup::Load( const char* szFileName )
{
...
bool CMarkup::ReadTextFile( const char* szFileName, string& strDoc, string* pstrError, int* pnFlags )
{
...
bool CMarkup::Save( const char* szFileName )
{
	return WriteTextFile( szFileName, m_strDoc, &m_strError, &m_nFlags );
}

bool CMarkup::WriteTextFile( const char* szFileName, string& strDoc, string* pstrError, int* pnFlags )
{
...
string CMarkup::EscapeText( const char* szText, int nFlags )
{
...
string CMarkup::UnescapeText( const char* szText, int nTextLength /*=-1*/ )
{
...
string CMarkup::GetAttribName( int n ) const
{
...
bool CMarkup::SavePos( const char* szPosName )
{
...
bool CMarkup::RestorePos( const char* szPosName )
{
...
string CMarkup::x_GetToken( const CMarkup::TokenPos& token )
{
...
int CMarkup::x_FindElem( int iPosParent, int iPos, const char* szPath ) const
{
...
string CMarkup::x_GetPath( int iPos ) const
{
	string strPath;
	while ( iPos )
	{
...
bool CMarkup::x_FindAttrib( CMarkup::TokenPos& token, const char* szAttrib, int n/*=0*/ )
{
...
string CMarkup::x_GetAttrib( int iPos, const char* szAttrib ) const
{
...
bool CMarkup::x_SetAttrib( int iPos, const char* szAttrib, int nValue )
{
...
bool CMarkup::x_CreateNode( string& strNode, int nNodeType, const char* szText )
{
...
string CMarkup::x_EncodeCDATASection( const char* szData )
{
...
bool CMarkup::x_SetData( int iPos, const char* szData, int nFlags )
{
...
string CMarkup::x_GetElemContent( int iPos ) const
{
...
bool CMarkup::x_SetElemContent( const char* szContent )
{
...
void CMarkup::x_DocChange( int nLeft, int nReplace, const string& strInsert )
{
...
bool CMarkup::x_AddElem( const char* szName, int nValue, int nFlags )
{
	// Convert integer to string
	char szVal[25];
	sprintf( szVal, "%d", nValue );
...
bool CMarkup::x_AddElem( const char* szName, const char* szValue, int nFlags )
{
	if ( nFlags & MNF_CHILD )
	{
...
string CMarkup::x_GetSubDoc( int iPos ) const
{
	if ( iPos )
	{
...
bool CMarkup::x_AddSubDoc( const char* szSubDoc, int nFlags )
{
...
bool CMarkup::x_AddNode( int nNodeType, const char* szText, int nFlags )
{
